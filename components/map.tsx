...
import { CollectionContainer } from "./layouts/collectioncard";
    ...
    return (
        <CollectionContainer>
            <Box height={'22vh'}  >
                ...
                bootstrapURLKeys={{ key: 'AIzaSyCvWR5A5_NW1e8YKzvpDjgGrR4tDlLdUwk'}}
    ...
    return (
        <>
            <MapComponent center={center} zoom={zoom}>
                    {photos.map(({src, location_lat, location_lng, width, height, alt, pid}) => 
